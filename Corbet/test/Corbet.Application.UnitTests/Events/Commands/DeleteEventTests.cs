...
using Corbet.Application.Features.Events.Commands.DeleteEvent;
using Corbet.Application.UnitTests.Mocks;
...
namespace Corbet.Application.UnitTests.Events.Commands
{
